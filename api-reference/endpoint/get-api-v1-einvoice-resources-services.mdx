...
description: "GET /api/v1/einvoice/resources/services"
openapi: "GET /api/v1/einvoice/resources/services"
---

**GET** `/api/v1/einvoice/resources/services`
...
- `search`:  Example: `Consultanting`

```bash
curl -X GET "{{BASE_URL}}/api/v1/einvoice/resources/services?start=1&length=10&code=01011&description=Horses; live, pure-bred breeding animals&search=Consultanting" \
