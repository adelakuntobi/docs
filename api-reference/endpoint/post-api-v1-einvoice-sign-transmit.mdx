---
title: "Sign and Transmit Invoice"
description: "POST /api/v1/einvoice/sign-transmit"
openapi: "POST /api/v1/einvoice/sign-transmit"
---

**POST** `/api/v1/einvoice/sign-transmit`

## Request example

```bash
curl -X POST "{{BASE_URL}}/api/v1/einvoice/sign-transmit" \
