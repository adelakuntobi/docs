...
description: "PATCH /api/v1/einvoice/update/{IRN}"
openapi: "PATCH /api/v1/einvoice/update/{IRN}"
---

**PATCH** `/api/v1/einvoice/update/{IRN}`

## Request example

```bash
curl -X PATCH "{{BASE_URL}}/api/v1/einvoice/update/{IRN}" \
